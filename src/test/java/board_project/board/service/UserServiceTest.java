...
class UserServiceTest {
    ...
    void 중복_회원_예외_테스트() {
        ...
        IllegalStateException e = assertThrows(IllegalStateException.class,
                ()->userService.join("회원B", "spring@gmail.com"));
    ...
    void 회원_전체_조회_테스트() {
        ...
        Long userId2 = userService.join("회원B", "jpa@gmail.com");
        ...
        assertThat(users.get(0).getName()).isEqualTo("회원A");
        assertThat(users.get(1).getName()).isEqualTo("회원B");
    }
